...
# serve txt file 
curl -s --output test4.txt localhost:8002/toto/txt.txt
diff test4.txt ./public/txt.txt
rm test4.txt

# serve pdf file 
curl -s --output test1.pdf localhost:8002/toto/web.pdf
diff test1.pdf ./public/web.pdf
rm test1.pdf

# serve gif file
curl -s --output test2.gif localhost:8002/toto/gunsNRoses.gif
diff test2.gif ./public/gunsNRoses.gif
rm test2.gif 

# serve jpeg file
curl -s --output test2.jpeg localhost:8002/toto/image.jpeg
